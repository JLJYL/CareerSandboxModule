...
class OpenAICompatibleLLM:
    ...
    def __init__(self, timeout_s: int = 60, model: str | None = None):
        self._model = model or settings.llm_model      # per-task 覆寫:擷取傳 4o,其餘吃預設
        if not (settings.llm_base_url and settings.llm_api_key and self._model):
